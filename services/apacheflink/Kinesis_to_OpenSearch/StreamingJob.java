...
public class StreamingJob {
    private static final String opensearchEndpoint = "https://search-oyaizu-se-xm25oyiw7mawufxkqwlh2c2vei.us-east-1.es.amazonaws.com";
    ...
    public static void main(String[] args) throws Exception {
        ...
        input.sinkTo(AmazonOpenSearchServiceSink.buildAmazonOpenSearchSink("stock", opensearchEndpoint, osRestClientFactory));
