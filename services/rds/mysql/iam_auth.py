...
# 環境変数から取得する値
# INPUT_BUCKET : 推論用データバケット
# INPUT_PREFIX : 推論対象データのプレフィックス
# INSTANCE_COUNT : バッチ変換ジョブのインスタンス数
# INSTANCE_TYPE : バッチ変換ジョブのインスタンスタイプ
# MODEL_NAME : バッチ変換ジョブで使用するモデル名
...
def lambda_handler(event, context):
    ...
    OUTPUT_PATH = os.environ.get("OUTPUT_PATH") + f"/{dt_str}"
