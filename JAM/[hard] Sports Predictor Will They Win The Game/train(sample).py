...
def prepare_data_for_xgboost():
    ...
    s3 = boto3.client('s3')
    bucket_name = 'my-challenge-bucket-101-768236330706-us-west-2'
    file_key = 'clean/output_87ab25ed-3bc8-4d3d-85b8-66b5fa3b7779/part-00000-1761e8ec-e2da-4c67-bedf-3044bffd2636-c000.csv' #Find the file_key in your S3 bucket where you exported the cleaned data. The file_key follows this format: "clean/output_{{########}}/{{file_name}}.csv"
