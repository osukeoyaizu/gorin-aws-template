## task1
### Lambdaレイヤー作成
S3URL:https://strands-dependencies-{account-id}-{region}.s3.{region}.amazonaws.com/e4674732ef784c4c569bddb7e6cf82f1

名前:Strands-layer

アーキテクチャ:x86_64

ランタイム:python3.11, python3.12

※Lambda(Strands-Agent)にレイヤーを追加する
